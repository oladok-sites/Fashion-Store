...
export default function HomeHero() {
	...
	return (
		<>
			...
			>
				<div className="mr-3">
					{/* <nav className="flex lg:flex-col justify-center gap-6 lg:gap-3 tracking-[0.25em] uppercase mb-5">
						<Link href="/products/?catt=men" type="button" className="hover:opacity-70 active:opacity-70">
							Men
						</Link>
						<Link href="/products/?catt=women" type="button" className="hover:opacity-70 active:opacity-70">
							Women
						</Link>
						<Link href="/products/?catt=kids" type="button" className="hover:opacity-70 active:opacity-70">
							Kids
						</Link>
					</nav> */}
