	...
	return (
		<section className="flex flex-col items-center py-15 leading-[83%] scroll-mt-37.5 text-center" id="approach">
			...
			<div className="grid grid-cols-2 gap-4 lg:flex lg:gap-9">
				<Image src="/approach-1.png" alt="Our approach" width={317} height={389} className="mb-18"/>
				<Image src="/approach-2.png" alt="Our approach" width={317} height={389} className="mt-18"/>
				<Image src="/approach-3.png" alt="Our approach" width={317} height={389} className="mb-18"/>
				<Image src="/approach-4.png" alt="Our approach" width={317} height={389} className="mt-18"/>
			</div>
		</section>
	);
}