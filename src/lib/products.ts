export const products = [
	...
	// ===== ELECTRONICS =====
	{
		...
		price: 129,
		description: 'Noise-cancelling wireless headphones with long battery life, delivering immersive sound quality and all-day comfort.',
	...
	},
	{
		...
		title: 'Smartphone',
		price: 699,
		description: 'Modern smartphone with a high-resolution display, fast performance, and advanced camera features for everyday tasks.',
		category: 'Electronics',
	...
	},
	{
		...
		title: 'Smart Watch',
		price: 249,
		description: 'Smart watch with fitness tracking features, health monitoring tools, and seamless integration with your smartphone.',
		category: 'Electronics',
	...
	},
	{
		...
		title: 'Modern Sofa',
		price: 899,
		description: 'Comfortable modern sofa with soft cushions, designed to provide excellent support and enhance your living space.',
		category: 'Furniture',
	...
	},
	{
		...
		title: 'Office Desk',
		price: 299,
		description: 'Spacious office desk perfect for a home workspace, offering enough room for productivity and organized storage.',
		category: 'Furniture',
	...
	},
	{
		...
		title: 'Bed Frame',
		price: 499,
		description: 'Sturdy bed frame with a modern design, providing reliable support, durability, and a stylish bedroom appearance.',
		category: 'Furniture',
	...
	},
	{
		...
		title: 'Bookshelf',
		price: 199,
		description: 'Tall bookshelf made from solid wood, offering multiple shelves for storing books, decor, and personal items.',
		category: 'Furniture',
	...
	// ===== SHOES =====
	{
		...
		price: 99,
		description: 'Lightweight running sneakers designed for comfort and performance, providing cushioning and support during workouts.',
		category: 'Shoes',
	...
	},
	{
		...
		title: 'Leather Boots',
		price: 149,
		description: 'Durable leather boots suitable for all seasons, offering strong construction, comfort, and a classic timeless style.',
		category: 'Shoes',
	...
	},
	{
		...
		price: 89,
		description: 'Everyday casual sneakers with a modern design, created for comfort, flexibility, and long-lasting daily wear.',
		category: 'Shoes',
		images: ['https://images.unsplash.com/photo-1519744792095-2f2205e87b6f'],
	},
	{
		id: 19,
		title: 'High Heels',
		price: 129,
		description: 'Elegant high heels designed for special occasions, combining a stylish silhouette with comfort and stability.',
		category: 'Shoes',
	...
	// ===== EXTRA + MIX =====
	{
		...
		price: 199,
		description: 'Stylish black leather jacket with a modern fit, offering durability, warmth, and a bold fashion statement.',
		category: 'Clothes',
	...
	},
	{
		...
		price: 69,
		description: 'Elegant slim fit trousers suitable for formal occasions, offering a clean silhouette and comfortable wear.',
		category: 'Clothes',
	...
	},
	{
		...
		title: 'Gaming Mouse',
		price: 59,
		description: 'High precision gaming mouse with RGB lighting, fast response time, and ergonomic design for long gaming sessions.',
		category: 'Electronics',
	...
	},
	{
		...
		title: '4K Monitor',
		price: 399,
		description: 'Ultra HD 4K monitor designed for professionals, delivering sharp visuals, accurate colors, and a large workspace.',
		category: 'Electronics',
	...
	},
	{
		...
		title: 'Coffee Table',
		price: 149,
		description: 'Modern coffee table with a wooden top, combining practical surface space with a clean and stylish interior design.',
		category: 'Furniture',
		images: ['https://images.unsplash.com/photo-1505691938895-1758d7feb511'],
	},
	{
		...
		price: 699,
		description: 'Spacious wardrobe cabinet with shelves and compartments, providing organized storage for clothes and accessories.',
		category: 'Furniture',
	...
	},
	{
		...
		title: 'TV Stand',
		price: 249,
		description: 'Modern TV stand with built-in cable management, helping keep your living room clean and visually organized.',
		category: 'Furniture',
		images: ['https://images.unsplash.com/photo-1586023492125-27b2c045efd7'],
	},
	{
		...
		title: 'Dining Table',
		price: 599,
		description: 'Large dining table made of solid wood, designed for family meals, durability, and a timeless interior look.',
		category: 'Furniture',
	...
	},
	{
		...
		price: 79,
		description: 'Comfortable slip-on sneakers for daily wear, offering quick wearability, flexibility, and casual modern style.',
		category: 'Shoes',
	...
	},
	{
		...
		title: 'Winter Boots',
		price: 179,
		description: 'Insulated winter boots designed for cold conditions, providing warmth, grip, and protection during winter walks.',
		category: 'Shoes',
	...
	},
	{
		...
		title: 'Canvas Shoes',
		price: 69,
		description: 'Light canvas shoes with a casual design, perfect for everyday outfits, warm weather, and comfortable walking.',
		category: 'Shoes',
		images: ['https://images.unsplash.com/photo-1525966222134-fcfa99b8ae77'],
	},
	{
		...
		title: 'Polo Shirt',
		price: 45,
		description: 'Classic polo shirt made from breathable fabric, combining a smart casual look with comfort for daily wear.',
		category: 'Clothes',
	...
	},
	{
		...
		title: 'Armchair',
		price: 349,
		description: 'Comfortable armchair with soft upholstery, designed for relaxation while adding a cozy accent to your interior.',
		category: 'Furniture',
		images: ['https://images.unsplash.com/photo-1519710164239-da123dc03ef4'],
	},
	{
		...
		title: 'Loafers',
		price: 129,
		description: 'Elegant loafers suitable for both casual and formal wear, offering comfort, style, and easy slip-on design.',
		category: 'Shoes',
		images: ['https://images.unsplash.com/photo-1549298916-b41d501d3772'],
	},
	{
		...
		category: 'Clothes',
		images: ['https://images.unsplash.com/photo-1542060748-10c28b62716f'],
	},
	{
		id: 46,
	...
	},
	{
		...
		price: 109,
		description: 'Training shoes designed for gym workouts, offering stability, comfort, and support during intense exercises.',
		category: 'Shoes',
		images: ['https://images.unsplash.com/photo-1600180758890-6b94519a8ba6'],
	},
	{
	...
	},
	{
		...
		title: 'Desk Lamp',
		price: 59,
		description: 'LED desk lamp with adjustable brightness, providing efficient lighting for work, reading, and daily tasks.',
		category: 'Furniture',
		images: ['https://images.unsplash.com/photo-1519710164239-da123dc03ef4'],
	},
];
export const ekfoeke = [
	{
		id: 1,
	...
	},
	{
		...
		category: 'Jackets',
		images: JSON.stringify(['/clothes/suede-jacket-2-1.jpg', '/clothes/suede-jacket-2-2.jpg', '/clothes/suede-jacket-2-3.jpg']),
	},
	{
		id: 3,
	...
	},
	{
		...
		category: 'Parfums',
		images: JSON.stringify(['/clothes/parfums-red-6-1.jpg', '/clothes/parfums-red-6-2.jpg', '/clothes/parfums-red-6-3.jpg']),
	},
	{
		id: 7,
...
NIGHT POUR HOMME III is a woody fragrance that reveals its elegant and fresh character, emphasized by a rainbow floral explosion. The olfactory pyramid opens with fruity notes of bergamot and pear, wrapped in iris, osmanthus, coriander and pepper. The base notes are woody notes of sandalwood and cashmere, accompanied by notes of leather and vetiver. This is a unique and seductive perfume, the charm of which is impossible to resist.`,
	...
	},
	{
		...
		price: 29,
		description:
			'Slim fit T-shirt. Round neck and short sleeves.Lighter than our basic mid-weight model.',
		category: 'T-shirts',
		images: JSON.stringify([
